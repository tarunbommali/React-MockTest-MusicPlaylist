...
class App extends Component {
  ...
  onChangeInput = event => {
    ...
    const filteredTrackList = initialTracksList.filter(eachTrack =>
  ...
  updateTrack = id => {
    ...
    const filteredTrackList = trackList.filter(eachTrack => eachTrack.id !== id)
  ...
  render() {
    const {trackList} = this.state
    const isDisplay = trackList.length === 0
      ...
      <div className="app-container">
        ...
        <div className="playlist-container">
          <div className="playlist-header">
            <h1 className="sub-title">Songs Playlist</h1>
